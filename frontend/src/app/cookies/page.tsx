...
export async function generateMetadata(): Promise<Metadata> {
  const page = await safeApiFetch<CmsPage>('/pages/cookies', { revalidate: 300 });
  return { title: `${page?.title ?? 'Cookie Settings'} - Greenland Business & Compliance` };
}
